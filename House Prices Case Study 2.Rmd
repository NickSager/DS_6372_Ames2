...
ames_non_dummy %>%
  select(sale_price, gr_liv_area, lot_area, overall_qual, overall_cond, year_built, year_remod_add, total_bsmt_sf, garage_area) %>%
  ggpairs(lower=list(continuous=lowerFn))
```

```{r}
# Fit a linear model with categorical variables to guage importance
...
Variable inclusion/explanation.
